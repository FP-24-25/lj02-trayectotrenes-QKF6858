...
public class TrayectoTrenImplTest {
	...
	private static void testConstructor(String codigoTren, String nombreTrayecto,
		...
		try {
			TrayectoTren trayecto = new TrayectoTrenImpl(codigoTren, nombreTrayecto,
	...
	public static void main(String[] args) {
		...
		TrayectoTren t = new TrayectoTrenImpl("12345", "Sevilla-Madrid",
